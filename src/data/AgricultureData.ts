...
export const sprayerCapacityInfo = [
    'Пригодна для перевозки как пищевых продуктов, так и  любых удобрений',
    'Длина — 1900 мм',
    'Ширина — 1010 мм',
    'Высота — 1120 мм',
    'Диаметр горловины — 400 мм',
    'Толщина стенки — 9 мм',
    'Комплектуется специальной герметичной крышкой для транспортировки',
];

export const pigsWaterersImg = [
    plastikovayaPoilka,
    holodnoeVyrashchivanie,
    poilkaPodogrev,
